...
object RestClient {
        ...
        newClimbStats.forEach { stats ->
            ...
            if (row.get("display_difficulty") != null) {
                ...
                db.delete(
                    ...
                    arrayOf(stats.climbUuid.toString(), stats.angle.toString())
                )
            }
        }
    ...
    private fun updateClimbs(newClimbs: List<SharedSyncResponse.PUT.Climb>, date: String) {
    ...
    private fun createSharedSyncRequestContent(): String {
        ...
        return json.encodeToString<SharedSyncRequest>(sharedSyncRequest)
    }
